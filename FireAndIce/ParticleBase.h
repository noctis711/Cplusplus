...
public:
    ...
    ParticleBase(double x, double y, double w, double h, bool fire)
      : m_x(x), m_y(y), m_w(w), m_h(h), m_collision(false), m_fire(fire) {};
    ...
    void setCollision(bool b){ m_collision = b; }

    virtual bool getPower(){ return m_fire; }
